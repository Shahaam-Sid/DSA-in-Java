...
public class FavouritesLists<E> {
    ...
    protected Position<Item<E>> findPosition(E e) {
        ...
        while (walk != null && !e.equals(value(walk))) walk = list.after(walk);
    ...
    protected void moveUp(Position<Item<E>> p) {
        ...
        while (walk != list.first() && count(list.before(walk)) < cnt) walk = list.before(walk);
    ...
    public void access(E e) {
        ...
        if (p == null) p = list.addLast(new Item<>(e));
